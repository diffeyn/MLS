...
sofifa_latest_team_stats = cleaning.hash_match_ids(sofifa_latest_team_stats)
sofifa_latest_player_stats = cleaning.hash_match_ids(sofifa_latest_player_stats)
sofifa_latest_feed = cleaning.hash_match_ids(sofifa_latest_feed)
...
utils.save_to_csv(sofifa_latest_team_stats, f'stats/latest_team_stats_{today}.csv')
utils.save_to_csv(sofifa_latest_player_stats, f'player_stats/latest_player_stats_{today}.csv')
